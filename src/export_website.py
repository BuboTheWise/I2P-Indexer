...
<div class="links">
  <a class="link-card" href="address_book.html" target="_blank" rel="noopener">
  ...
  <a class="link-card" href="hosts.txt" target="_blank" rel="noopener">
    <span class="icon">📋</span>
  ...
  <a class="link-card" href="https://github.com/BuboTheWise/I2P-Indexer" target="_blank" rel="noopener">
    <span class="icon">⚡</span>
